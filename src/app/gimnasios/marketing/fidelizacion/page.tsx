...
export const metadata: Metadata = {
  title: "Sistemas de Retención Predictiva para Gimnasios | Impulse Fitness",
  description:
    "Inteligencia artificial aplicada a la fidelización de socios: alertas de ausentismo automáticas, gamificación por logros y recuperación de recibos sin fricción.",
};
    ...
    <div className="flex flex-col space-y-12 animate-fadeIn max-w-5xl mx-auto w-full py-4">
      ...
      <div>
        ...
        <header className="border-b border-gray-100 pb-8">
          <div className="inline-flex items-center space-x-2 text-xs font-bold text-green-600 bg-green-50 px-3 py-1 rounded-full uppercase tracking-wider mb-4">
            <span>Pilar 2 • Fidelización & IA</span>
          </div>
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-black text-[#111827] tracking-tight leading-tight">
            Retención Impulsada por Datos
          </h1>
          <p className="mt-4 text-base sm:text-lg text-gray-600 leading-relaxed max-w-3xl">
            Cuesta 5 veces más captar a un cliente nuevo que retener a uno actual. Usamos la inteligencia artificial para predecir qué socios están a punto de darse de baja antes de que lo hagan.
          </p>
        </header>
      </div>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-4">
        <div className="bg-white rounded-2xl border border-gray-100 p-8 shadow-sm flex flex-col justify-between">
          <div>
            ...
            <p className="mt-3 text-sm text-gray-600 leading-relaxed">
              El sistema detecta cuando un usuario baja su frecuencia de asistencia y lanza campañas de reactivación automáticas.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-8 shadow-sm flex flex-col justify-between">
          <div>
            ...
            <p className="mt-3 text-sm text-gray-600 leading-relaxed">
              Correos de felicitación por alcanzar hitos (ej. "Tu entrenamiento número 100") para aumentar el sentimiento de pertenencia.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-8 shadow-sm flex flex-col justify-between">
          <div>
            ...
            <p className="mt-3 text-sm text-gray-600 leading-relaxed">
              Embudos específicos para gestionar cobros devueltos sin fricción comercial ni llamadas incómodas en recepción.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gray-50 rounded-3xl border border-gray-100 p-8 sm:p-12 text-center max-w-3xl mx-auto w-full mt-6">
        <h2 className="text-xl sm:text-2xl font-black text-[#111827]">
          ¿Preparado para blindar tu base de clientes?
        </h2>
        <p className="mt-2 text-sm sm:text-base text-gray-600 max-w-lg mx-auto">
          Implementa algoritmos de fidelización y reduce hasta un 22% la tasa de abandono en los primeros 90 días críticos.
        </p>
        <div className="mt-8">
          <Link
          ...
          >
            <span>Quiero reducir mis bajas mensuales</span>
            <span>→</span>
          </Link>
        </div>
      </section>
